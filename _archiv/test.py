...
# window.close()
# cmd = "scanimage kash khsdafkh sdak"
# cmd = "lss"
...
# cmd = "ls"
# retval, output = runCommand(cmd)
# print("RETVAL", retval)
# print("OUTPUT", output)

import re

target_str = "Progress: 80.2% Progress: 82.2% Progress: 99.2%"

# \s+ to match all whitespaces
# replace them using single space " "
res_str = re.sub(r"Progress: \d{1,3}.\d%", "", target_str)
print(res_str)